...
const OrderScreen = () => {
 ...
 const { data: order, refetch, isLoading, error, } = useGetOrderDetailsQuery(orderId);
  ...
  const deliverHandler = async () => { await deliverOrder(orderId); refetch(); };
          ...
          <Card>
            <ListGroup variant='flush'>
              ...
              {userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
                  <ListGroup.Item> <Button type='button' className='btn btn-block' onClick={deliverHandler} > Mark As Delivered </Button> </ListGroup.Item>
                )}
            </ListGroup>
          </Card>
        </Col>
